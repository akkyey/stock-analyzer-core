...
class IntegrationPhase(BasePhase):
    ...
    def execute(self, df: Optional[pl.DataFrame | Dict] = None) -> Optional[pl.DataFrame]:
    ...
    def _verify_physical_outputs(self, report_paths: Dict[str, str]):
        """生成ファイルの存在とサイズの検証"""
    ...
    def _sync_external_services(self, report_paths: Dict[str, str], df: pl.DataFrame):
        """外部サービスとの同期処理"""
