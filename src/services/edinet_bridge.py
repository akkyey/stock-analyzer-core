    ...
    def bridge_all(self, purge_after: bool = False) -> int:
        ...
        for filename in json_files:
            ...
            try:
                ...
                if record["sales"] and record["operating_income"] and record["sales"] > 0:
                    record["operating_margin"] = (record["operating_income"] / record["sales"]) * 100.0
        ...
        if data_to_upsert:
            try:
                ...
                self.logger.info(f"✅ Successfully bridged and repaired {len(repaired_records)} records.")
